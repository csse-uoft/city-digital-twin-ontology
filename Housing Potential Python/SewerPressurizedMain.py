...
for element in data["features"]:
    ...
    g.add((toronto["wastewaterservicepressurizedmain" + objectid], RDF.type, toronto.TorWastewaterService))
    ...
    g.add((toronto["wastewaterservice_pressurizedmain" + objectid + "Site"], genprop.hasName, Literal("Sewer " + element['properties']['Sewer Pressurized Asset Identification'])))
    ...
    g.add((toronto["wastewaterservice_pressurizedmain_loc" + objectid], geo.asWKT, Literal(shapely.to_wkt(make_valid(shapely.geometry.shape(element["geometry"])), rounding_precision=-1), datatype=geo.wktLiteral)))
