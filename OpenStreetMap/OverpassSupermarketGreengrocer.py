...
"""
OverpassSupermarketGreengrocer.py
...
indicators for supermarkets/greengrocers using OpenStreetMap data.
...
amenity = "SupermarketGreengrocer"
walkdistance = "400"
            ...
            while True:
                try:
                    ...
                    (
                      ...
                      nwr[shop=greengrocer](around.buildings:""" + walkdistance + """); 
                    )->.amenity; 
