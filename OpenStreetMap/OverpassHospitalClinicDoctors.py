...
"""
OverpassHospitalClinicDoctors.py
...
indicators for hospitals, clinics (i.e. medical centres), and doctor's offices using OpenStreetMap data.
            ...
            while True:
                try:
                    ...
                    (
                      ...
                      nwr[amenity=clinic](around.buildings:""" + walkdistance + """);
                      nwr[amenity=doctors](around.buildings:""" + walkdistance + """);
                    )->.amenity; 
