...
indicators for restaurants/fast food restaurants using OpenStreetMap data.
...
for n in range(len(df)):
            ...
            while True:
                try:
                    ...
                    (
                      ...
                      nwr[amenity=fast_food](around.buildings:""" + walkdistance + """); 
                    )->.amenity; 
    ...
    if n == 0:
        ...
        g.add((cdt.PercentWalkingDistanceRestaurantFastFood, rdfs.subClassOf, cdt.PercentWalkingDistance))
